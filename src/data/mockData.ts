...
export const mockUserProfile: UserProfile = {
  name: 'AI创作者',
  bio: '专注于AI生成艺术创作，擅长使用Midjourney、Stable Diffusion、Runway等工具进行创意创作。热衷于探索人工智能与艺术的边界，致力于打造独特的视觉体验。',
  ...
  advantages: '精通多种AI艺术生成工具，能够快速实现创意想法。具备扎实的视觉设计基础，对色彩、构图、光影有深入理解。擅长AI工具与传统设计软件的协同工作流程。',
  education: [
    {
      school: '清华大学',
      major: '数字媒体艺术',
      ...
      period: '2018-2022',
      gpa: '3.8/4.0',
      courses: ['交互设计', '数字影像创作', '计算机图形学', '虚拟现实技术', '动画原理', '创意编程'],
      achievements: '获校级优秀毕业生称号，毕业设计《数字艺术的边界》获优秀论文奖',
    },
    {
      school: '中央美术学院',
      major: '视觉传达设计',
      ...
      period: '2022-2024',
      gpa: '90/100',
      courses: ['品牌设计策略', '排版设计', '数字媒体艺术', '视觉系统设计', '用户研究方法', '设计心理学'],
      achievements: '获国家奖学金，作品《城市视觉符号》入选全国设计大展',
    },
  ],
  honors: [
    {
      ...
      issuer: '国际AI艺术大赛组委会',
      date: '2024年3月',
      description: '凭借《赛博朋克城市系列》获得年度最佳AI艺术创作奖',
    },
    {
      title: '优秀创意设计师',
      issuer: '中国设计师协会',
    ...
    },
    {
      ...
      issuer: '亚洲数字艺术展',
      date: '2023年8月',
      description: '《抽象自然》系列作品获得数字艺术创新奖',
    },
  ],
  socialLinks: {
